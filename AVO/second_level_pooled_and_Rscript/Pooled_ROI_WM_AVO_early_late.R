...
names <- c(
  ...
  "onset_csav_early#0_Tstat",
   "onset_csunav_early#0_Coef",
   "onset_csunav_early#0_Tstat",
  "onset_csm_late#0_Coef",
  "onset_csm_late#0_Tstat",
  "onset_csav_late#0_Coef",
  "onset_csav_late#0_Tstat",
   "onset_csunav_late#0_Coef",
   "onset_csunav_late#0_Tstat",
   "shock#0_Coef",
   "shock#0_Tstat",
   "press#0_Coef",
   "press#0_Tstat",
   ...
   "onset_csav_early_vs_onset_csm_early#_Tstat",
   "onset_csm_early_vs_onset_csav_early#0_Coef",
   "onset_csm_early_vs_onset_csav_early#0Tstat",
   ...
   "csav_early_vs_csm_early_minus_csav_late_vs_csm_late#0_Tstat",
...
read.subject.roi <- function(subjroi) {
   subj <- subjroi[[1]]
   roi <- subjroi[[2]]
   filename <- paste0("derivatives/afni/",subj,"/Avoidance/FL_results_ROI_WM_pooled_early_late/betas_ROI_",roi,"_REML.1D")
...
write.table(X, file="derivatives/afni/SL/AVO/SL_pooled_ROI_WM_AVO_early_late.csv", sep=",", row.names=FALSE)
