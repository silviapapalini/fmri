...
for subj in $subjects; do
	...
	result_WB_prefix="derivatives/afni/$subj/${task}/FL_results_WB_parametric_modulation_hp"
	result_ROI_prefix="derivatives/afni/$subj/${task}/FL_results_ROI_parametric_modulation_hp"
...
afni_modulated(X[["omission_csm"]], "relief_csm_modulated")
