...
read.subject.roi <- function(subjroi) {
   ...
   filename <- paste0("derivatives/afni/",subj,"/Avoidance/FL_results_ROI_non_pooled/betas_ROI_",roi,"_REML.1D")
...
write.table(X, file="derivatives/afni/SL/SL_TbyT_ROI_AVO.csv", sep=",", row.names=FALSE)
